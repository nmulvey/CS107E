 ...
 * name: Nicole Mulvey
 * This is the test file for the keyboard and shell
 */
#include "assert.h"
#include "keyboard.h"
#include "printf.h"
...
static void shell_loop_until_esc(void) {
    shell_init(keyboard_read_next, printf); // Initialize shell with keyboard input and printf output
    printf("Shell started. Press ESC to exit.\n");
    ...
    while (1) {
        ...
        if (line[0] == 27 && line[1] == '\0') { // ASCII code 27 is ESC
...
void main(void) {
   ...
   //shell_loop_until_esc(); //test shell with loop
